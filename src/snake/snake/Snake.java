...
public class Snake extends JPanel implements Runnable, KeyListener
{
    ...
    /**
     * Cr�� un nouveau serpent
     * @param tete le Block repr�sentant sa t�te
    ...
    /**
     * R�sussite le serpent
     * @param tete le Block repr�sentant sa tete
     * @param nbrQueu le nombre de Block en plus de sa tete
     */
    ...
    public void avance()
    {
        ...
        {
            tete.avance(dir);//On fait avancer la tete toujours dans la m�me direction
            dirAv=dir;
        }
        else
     ...
     * Snake.PLAY: vivant
     * Snake.PAUSE: en pause
     * @param statue statue � donner au serpent
     */
